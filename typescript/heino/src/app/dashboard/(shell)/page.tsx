...
export default async function DashboardPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
      ...
      {/* Recent access — the one home-page list with no dedicated page; org and
          course lists were removed because /dashboard/organizations and each
          org's courses page already cover them in richer form. */}
